...
<html lang="en">
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        ...
        <!-- <link rel="stylesheet" href="css/insertregiform.css"> -->
    </head>
    <body>
        <div class=centered-text>
            ...
            $userFirstName = $_POST["first-name"] ?? '';  // Use "??" to avoid errors if key is undefined
            ...
            // Prepare a SQL query to check if the email or phone number exists
